...
<span style="color: #0000ff">**Linux下的五种IO模型**</span>
...
<span style="color: #ff0000">总结下select的几大缺点：</span>
...
*   [Linux的Socket IO模型趣解](/article/97495.htm "Linux的Socket IO模型趣解")
*   [linux上TCP connection timeout问题解决办法](/article/111163.htm "linux上TCP connection timeout问题解决办法")
*   [Linux IO的水平触发和边缘触发的区别](/article/113615.htm "Linux IO的水平触发和边缘触发的区别")
</div>
...
<div id="shoucang"></div>
<div class="tags mt10">
**Tags：**[Linux](http://common.jb51.net/tag/Linux/1.htm "搜索关于Linux的文章") [IO](http://common.jb51.net/tag/IO/1.htm "搜索关于IO的文章") [模型](http://common.jb51.net/tag/%E6%A8%A1%E5%9E%8B/1.htm "搜索关于模型的文章") 
</div>
<div class="relatedarticle clearfix mt5">

## 相关文章

*   <span>2016-12-12</span>[详解CentOS7下安装Mysql和配置mysql](/article/101636.htm "详解CentOS7下安装Mysql和配置mysql")
*   <span>2017-06-06</span>[Debian 9系统下修改默认网卡为eth0的方法](/article/116662.htm "Debian 9系统下修改默认网卡为eth0的方法")
*   <span>2017-01-01</span>[CentOS 安装 Mongodb详解（在线和离线）](/article/102769.htm "CentOS 安装 Mongodb详解（在线和离线）")
*   <span>2009-09-09</span>[正确维护配置Apache服务器的方法 保护系统安全](/article/20034.htm "正确维护配置Apache服务器的方法 保护系统安全")
*   <span>2016-12-12</span>[浅谈在linux kernel中打印函数调用的堆栈的方法](/article/101050.htm "浅谈在linux kernel中打印函数调用的堆栈的方法")
*   <span>2016-10-10</span>[ubuntu下安装Python多版本的方法及注意事项](/article/95498.htm "ubuntu下安装Python多版本的方法及注意事项")
*   <span>2014-07-07</span>[linux NFS安装配置及常见问题、/etc/exports配置文件、showmount](/article/52004.htm "linux NFS安装配置及常见问题、/etc/exports配置文件、showmount命令")
*   <span>2017-08-08</span>[关于安装linux redhat后无法使用yum命令安装gcc-c++问题的解决过](/article/122241.htm "关于安装linux redhat后无法使用yum命令安装gcc-c++问题的解决过程")
*   <span>2014-07-07</span>[Windows下安装Apache 2.2.21图文教程](/article/52086.htm "Windows下安装Apache 2.2.21图文教程")
*   <span>2013-06-06</span>[apache启动报 shmget() failed: Invalid argument的解决方法](/article/38348.htm "apache启动报 shmget() failed: Invalid argument的解决方法")
</div>
...
<div class="pd5"><div id="SOHUCS" sid="art_94783"></div></div>
</div>
      </div><!--endborder-->
      </div>